      ...
      <div className="authenticate--container">
        <div className="authenticate--content">
          ...
          <div className="checkPhone--wrapper__body">
            <p className="text-center">Vui lòng nhập số điện thoại để tiếp tục</p>
            ...
            <div className="text-center">Đăng nhập bằng tài khoản</div>
            <div className="socialBtn">
              <ul className="socialBtn--group">
                <li className="socialBtn--item">
                  <Button className="socialBtn--btn">
                    <div className="socialBtn--btn__item">
                      <div>
                        <img
                          ...
                          alt=""
                          className="socialBtn--img"
                        />
                      </div>
                      <div className="socialBtn--btn__title">Đăng nhập với Google</div>
                    </div>
                  </Button>
                </li>
                <li className="socialBtn--item">
                  <Button className="socialBtn--btn">
                    <div className="socialBtn--btn__item">
                      ...
                      <div className="socialBtn--btn__title">Đăng nhập với Facebook</div>
                    </div>
                  </Button>
                </li>
              </ul>
