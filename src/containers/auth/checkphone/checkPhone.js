...
function CheckPhone() {
  ...
  // handle onChange input Phone number
  ...
  // handle catch the Enter btn press event
          ...
          <div className="socialBtn">
            <ul className="socialBtn--group">
              <li className="socialBtn--item">
                <Button onClick={handleBtnLoginGoogle} className="socialBtn--btn">
              ...
              <li className="socialBtn--item">
                <Button onClick={handleBtnLoginFacebook} className="socialBtn--btn">
                  <div className="socialBtn--btn__item">
                    <div>
                      <img
